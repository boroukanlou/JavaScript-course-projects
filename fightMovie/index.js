...
const runComparision = () => {
  ...
  leftSideStats.forEach((leftStat, index) => {
    const righStat = rightSideStats[index];

    if (parseInt(leftStat.dataset.value) < parseInt(righStat.dataset.value)) {
      leftStat.classList.remove("is-primary");
      leftStat.classList.add("is-danger");
    } else {
      righStat.classList.remove("is-primary");
      righStat.classList.add("is-danger");
    }
  });
};
